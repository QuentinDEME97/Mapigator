...
pub struct Vertex {
  ...
  pub coordinate_type: utils::CoordinateType,
...
impl VertexFactory {
  ...
  pub fn create_vertex(
    ...
    base_id: Option<i64>,
    coordinates: (f64, f64),
    coordinate_type: utils::CoordinateType,
  ) -> Vertex {
    let id = self.next_id;
    self.next_id += 1;
    Vertex {
...
mod tests {
  ...
  fn test_factory_increments_id() {
    ...
    let v1 = factory.create_vertex(None, (0.0, 0.0), utils::CoordinateType::XY);
    let v2 = factory.create_vertex(Some(2346237), (32.3, 48.9), utils::CoordinateType::GEO);
